...
import { buildGifData, buildCharacterData, buildEpisodeData, buildSeasonData } from './structuredDataBuilder'
import type { GifItem, CharacterItem, EpisodeItem, SeasonItem } from '~/types/structuredData'
